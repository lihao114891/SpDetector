...
if __name__ == '__main__':
    ...
    print('1. DegreeSAD   2.CoDetector   3.SpectrumDetector 9.DLDRA\n')
    print('Semi-Supervised Methods:')
    print('4. SemiSAD\n')
    print('Unsupervised Methods:')
    print('5. PCASelectUsers    6. FAP   7.timeIndex 8.BayesDetector\n')
    print('-'*80)
    algor = -1
    conf = -1
    ...
    if order == '1':
        ...
        conf = Config('../config/SpectrumDetector.conf')
